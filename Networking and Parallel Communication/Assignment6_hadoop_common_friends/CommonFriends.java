...
public class CommonFriends extends Configured implements Tool {
    ...
    private static final Logger LOG = Logger.getLogger(CommonFriends.class);
    ...
    public int run(String[] args) throws Exception {
        ...
        LOG.info("Tool name: " + CommonFriends.class.getSimpleName());
        LOG.info(" - input path: " + inputPath);
        LOG.info(" - output path: " + outputPath);
        LOG.info(" - num reducers: " + reduceTasks);

        Job job = new Job(getConf());
        job.setJobName(CommonFriends.class.getSimpleName());
        ...
        job.setMapOutputKeyClass(TwoNodeWritable.class);
    ...
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new CommonFriends(), args);
    }
}
